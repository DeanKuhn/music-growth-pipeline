...
8. **Open — fix decided (2026-09-23).** Last.fm hosts a mojibake duplicate of 照井順政 (Junsei Terui): artist `2552` is named `ç…§äº•é †æ”¿` — the UTF-8 bytes `E7 85 A7 / E4 BA 95 / E9 A0 86 / E6 94 BF` decoded as Windows-1252. It ranked #19 on /leaderboards (Fastest Growing %, All sizes, snapshot 2026-09-13).
