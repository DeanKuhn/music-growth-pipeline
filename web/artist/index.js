  ...
  const rows = artist.similar.map(function(s) {
    ...
    return `
			<tr class="border-t border-gray-800">
				...
				<td class="py-2 px-3 text-right whitespace-nowrap hidden sm:table-cell">${formatNum(s.latest_listeners)}</td>
				<td class="py-2 px-3 text-right whitespace-nowrap hidden sm:table-cell">${s.total_pct_growth}%</td>
				<td class="py-2 px-3 text-right whitespace-nowrap ${signColor}">${sign}${delta}%</td>
			</tr>
		`;
  }).join("");
